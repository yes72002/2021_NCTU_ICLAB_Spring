...
# set link_library {* dw_foundation.sldb standard.sldb slow.db RA1SH_cache_all.db}
# set link_library {* dw_foundation.sldb standard.sldb slow.db RA1SH_cache_128.db}
set link_library {* dw_foundation.sldb standard.sldb slow.db RA1SH_cache_256.db}
# set link_library {* dw_foundation.sldb standard.sldb slow.db RA1SH_cache_256.db RA1SH_cache_512.db}
